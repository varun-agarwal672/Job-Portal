...
from AccountsUser.forms import *
from AccountsUser.models import User

# Create your views here.

class RegisterEmployeeView(CreateView):
###Provides the ability to register as an employee
    model = User
